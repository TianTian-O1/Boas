...
private:
    ...
    // Boas Dialect operations (暂时注释掉)
    // mlir::Value generateBoasDialectMatmul(const MatmulExprAST* expr, mlir::Value lhs, mlir::Value rhs,
    //                                      mlir::Value m, mlir::Value n, mlir::Value k);
...
public:
    ...
    // 公共访问方法
    mlir::OpBuilder* getBuilder() { return builder.get(); }
